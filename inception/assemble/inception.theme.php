...
class Inception extends XtTheme implements XtITheme
{
    ...
    public function init()
    {
        ...
        $rmTpl->add_style('base.css', 'inception', [], 'theme');
        $rmTpl->add_style('skeleton.css', 'inception', [], 'theme');
        $rmTpl->add_style('layout.css', 'inception', [], 'theme');
        $rmTpl->add_style('inception-css.php', 'inception', [], 'theme');
        $rmTpl->add_style('superfish.css', 'inception', [], 'theme');

        // Scripts
        $rmTpl->add_script('hoverIntent.js', 'inception', [], 'theme');
        $rmTpl->add_script('superfish.js', 'inception', [], 'theme');
        $rmTpl->add_script('supersubs.js', 'inception', [], 'theme');
        $rmTpl->add_script('inception.js', 'inception', [], 'theme');

        if ($xtAssembler->isHome()) {
            $rmTpl->add_style('flexslider.css', 'inception', [], 'theme');
            $rmTpl->add_script('jquery.flexslider-min.js', 'inception', [], 'theme');
